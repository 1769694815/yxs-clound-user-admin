...
.cont-r .nav-tabs li.active {
  background: rgb(255, 255, 255);
}
.cont-r .nav-tabs li a {
...
.cont-r .tab-content .batch-type .simulationOption {
...
.cont-r .tab-content .batch-type .simulationOption div:hover {
  background: rgb(26, 140, 254); color: rgb(255, 255, 255); cursor: pointer;
}
.cont-r .tab-content .batch-type .simulationSelect em {
  color: rgb(26, 140, 254);
}
.cont-r .tab-content .batch-type .simulationOption.testType {
  left: 0px; color: rgb(74, 74, 74);
}
.body-content .cont-r .tab-content .batch-type .simulationOption.difficult {
  left: 0px; color: rgb(74, 74, 74);
}
#inputArea {
