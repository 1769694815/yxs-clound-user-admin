  ...
  <div class="app-container calendar-list-container">
    ...
    >
      <template slot="menuLeft">
        <el-button
          v-if="permissions['course_coursestudent_add']"
          type="primary"
          icon="el-icon-plus"
          size="mini"
          @click="handleCreate"
      ...
      <template slot="menu" slot-scope="scope">
        ...
        <el-button
          v-if="permissions['course_coursestudent_edit']"
          type="text"
          icon="el-icon-view"
          size="mini"
        ...
        >编辑</el-button>
        <el-button
          v-if="permissions['course_coursestudent_del']"
          type="text"
          size="mini"
          icon="el-icon-delete"
    ...
    <el-dialog :visible.sync="dialogPvVisible" :title="operationStatus | dialogTitle">
      <el-row style="padding: 0 20px;" :span="24" :gutter="20">
        <el-form ref="dataForm" :rules="formRules" :model="form">
          ...
          <el-col :span="12">
            <el-form-item prop="courseId" label="课程标题:" :label-width="formLabelWidth">
              <el-input
...
<script>
import { addObj, delObj, fetchList, putObj, importStudent } from '@/api/course/coursestudent'
  ...
  methods: {
    ...
    handleImportLog() {
      this.$router.push({
        ...
        query: {
          type: 0,
          objId: this.$route.query.courseId
        }
      })
    },
    /**
