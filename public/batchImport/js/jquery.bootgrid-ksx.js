        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                ...
                column = {
                    ...
                    text: $this.html().indexOf("icon")>-1?$this.html():$this.text(),
    ...
    */
        ...
        if (this.options.ajax)
        {
            ...
            var settings = {
                ...
                success: function(response)
                {
                    ...
                    if(!response.rows){
                        response.rows = [];//如果返回的rows为null，将rows置为空数组
                    }
    ...
    function renderColumnSelection(actions)
    {
        if (this.options.columnSelection && this.columns.length > 1)
        {
            ...
            dropDown.find(getCssSelector(css.dropDownMenuItems)).addClass("custom-settings");
    ...
    function renderRowCountSelection(actions)
    {
        ...
        if ($.isArray(rowCountList))
        {
            ...
            dropDown.find(menuTextSelector).addClass("page-count-span");
            actions.append(dropDown);
        }
    }
                ...
                var sortOrder = that.sortDictionary[column.id],
                    iconCss = ((sorting && sortOrder && sortOrder === "asc") ? css.iconUp :
                        (sorting && sortOrder && sortOrder === "desc") ? css.iconDown :
                            ((column.id == "sender") ? css.iconOperation : " icon-a_filtrate ")),
        ...
        if (sorting)
        {
            ...
            headerRow.off("click" + namespace, sortingSelector)
                .on("click" + namespace, sortingSelector, function (e)
                {
                    ...
                    // if($index === 2 || $index === 5 || $index === 6){ //不知道为什么要这么写
    ...
    function setTableHeaderSortDirection(element)
    {
        ...
        {
            element.parents("tr").first().find(iconSelector).removeClass(css.iconDown + " " + css.iconUp).addClass("icon-a_filtrate");
            this.sortDictionary = {};
        }
        ...
        if (sortOrder && sortOrder === "asc")
        {
            ...
            icon.removeClass(css.iconUp).removeClass("icon-a_filtrate").addClass(css.iconDown);
        }
        else if (sortOrder && sortOrder === "desc")
        {
            if (this.options.multiSort)
            {
                ...
                icon.removeClass(css.iconDown).removeClass("icon-a_filtrate");
            }
            else
            {
                this.sortDictionary[columnId] = "asc";
                icon.removeClass(css.iconDown).removeClass("icon-a_filtrate").addClass(css.iconUp);
            }
        }
        else
        {
            this.sortDictionary[columnId] = "asc";
            icon.removeClass("icon-a_filtrate").addClass(css.iconUp);
        }
    }
    ...
    var Grid = function(element, options)
    {
        ...
        //这里判断一下当前页面中是否存在变量customPageCount
        this.rowCount = typeof customPageCount != "undefined"?customPageCount:(($.isArray(rowCount)) ? rowCount[0] : rowCount);
        this.rows = [];
        this.searchPhrase = "";
        this.selectedRows = [];
        this.sortDictionary = {};
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            iconDown: "icon-a_descending",
            iconRefresh: "glyphicon-refresh",
            iconSearch: "glyphicon-search",
            iconUp: "icon-a_ascending",
